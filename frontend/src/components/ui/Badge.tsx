...
const styles: Record<BadgeUrgency, string> = {
  ...
  warning: 'bg-[color:var(--color-expiry-warning)]/10 text-[color:var(--color-expiry-warning)]',
  danger: 'bg-[color:var(--color-expiry-danger)]/10 text-[color:var(--color-expiry-danger)]',
};
...
export default function Badge({ urgency, expiryDate, className, children }: BadgeProps) {
